...
import { DayPicker } from "@/app/components/ui/day-picker";
...
import { DayViewMultiDayEventsRow } from "@/app/components/calendar/views/week-and-day-view/day-view-multi-day-events-row";
...
export function CalendarDayView({ singleDayEvents, multiDayEvents }: IProps) {
  ...
  return (
    <div className="flex">
        ...
        <div>
          ...
          <div className="relative z-20 flex border-b">
            ...
            <span className="flex-1 border-l py-2 text-center text-xs font-medium text-t-quaternary">
              {format(selectedDate, "EE", { locale: fr })}{" "}
      ...
      <div className="hidden w-80 divide-y border-l md:block">
        <DayPicker
        ...
        <div className="flex-1 space-y-3">
          {currentEvents.length > 0 ? (
            ...
            <p className="p-4 text-center text-sm italic text-t-tertiary">
              Aucun rendez-vous ou consultation pour le moment
            </p>
          )}
